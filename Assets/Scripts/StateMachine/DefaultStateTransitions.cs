...
namespace SandwichGame.StateMachine
{
    public static class DefaultStateTransitions
    {
        public static List<StateTransitionData> Build()
        {
            ...
            Add(t,"BREAD_BAG_CLOSED_LOAF","Open",null,"BREAD_BAG_OPENED_LOAF"); Sizes(t,"BREAD_BAG_OPENED_LOAF","Cut","_CUT_BREAD_LOAF");
            ...
            Sizes(t,"MAYO_BOTTLE_CLOSED","TakeOff","_TAKEOFF_MAYO"); return t;
        }
